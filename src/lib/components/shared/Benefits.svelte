<div class="h-[80px]" id="benefits"></div>
<div class="text-center space-y-4">
    <h2 class="text-4xl md:text-6xl font-bold tracking-tight text-white flot-b">
        NO BS <span class="bg-[#ccfc7e] text-black px-2">YAP</span>
    </h2>
</div>
<div class="h-8"></div>
<div class="max-w-6xl mx-auto grid gap-8 md:grid-cols-3 rounded-2xl px-4">
    ...
    <div class="bg-white cursor-default rounded-2xl p-8 shadow-lg hover:shadow-md transition-all duration-300 border border-gray-100 hover:scale-105">
        ...
        <p class="text-gray-600 leading-relaxed">What happens next might surprise you—more likes, more comments, more connections.</p>
    </div>
    ...
    <div class="bg-white cursor-default rounded-2xl p-8 shadow-lg hover:shadow-md transition-all hover:scale-105 duration-300 border border-gray-100">
        ...
        <p class="text-gray-700 leading-relaxed">As you continue using Metag, your workflow simplifies. You’re writing less and achieving more</p>
    </div>
    ...
    <div class="bg-white cursor-default rounded-2xl p-8 shadow-lg hover:shadow-md transition-all hover:scale-105 duration-300 border border-gray-100">
        ...
        <p class="text-gray-600 leading-relaxed">Become a thought leader & attract new opportunities.</p>
    </div>
</div>