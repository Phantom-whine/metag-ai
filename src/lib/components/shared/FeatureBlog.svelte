<div class="bg-[#ccfc7e] p-6 md:p-12 lg:p-12 w-[95%] mx-auto mt-8 rounded-[50px]">
    <div class="max-w-7xl mx-auto grid gap-12 lg:grid-cols-2 lg:gap-16 items-center">
        <div class="space-y-6">
            ...
            <p class="text-black text-lg md:text-xl max-w-xl flot">
                Without even realizing it, you’ll start writing in the exact format LinkedIn favors most.
            </p>
        </div>
                    ...
                    <div class="flex items-start justify-between mb-4">
                        <div class="flex items-center gap-4">
                            <div class="w-14 h-14 flex items-center justify-center">
                                <img src="./logo.png" alt="Human Written" class="w-14 h-14">
                            </div>
                            <div>
